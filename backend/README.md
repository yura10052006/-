...
Логіка бекенда (цикл tool use, обробка помилок, токен, ендпоінт) покрита
автотестами з підробленими зовнішніми викликами — **ключі для них не потрібні**:

```bash
pip install -r requirements-dev.txt
pytest            # 11 тестів, ~1 с
```
